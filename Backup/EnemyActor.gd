# EnemyActor.gd - Basic enemy with AI behavior
...
func setup_enemy_texture():
	var sprite_sheet = preload("res://Assets/32rogues/monsters.png")
	var atlas_texture = AtlasTexture.new()
	atlas_texture.atlas = sprite_sheet
	
	atlas_texture.region = Rect2(Vector2(0, 0), Vector2(32, 32)) # Example: region at (0,0) with size 32x32
